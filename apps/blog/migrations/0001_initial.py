    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail', models.ImageField(blank=True, default='default.jpg', upload_to='images/thumbnails/', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['png', 'jpg', 'jpeg', 'gif'])], verbose_name='Изображение')),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['fixed', '-create', '-status'], name='blog_post_fixed_988663_idx')],
            },
        ),
    ]
